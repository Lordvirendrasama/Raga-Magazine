...
export function Footer() {
  ...
  return (
    <footer className="bg-accent text-black border-t-4 border-accent-deep pb-10">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-4 md:text-left">
          <div className="md:col-span-2">
            ...
            <p className="mt-2 text-sm text-black/80 max-w-md mx-auto md:mx-0">
          ...
          <div className="md:justify-self-center">
            <h3 className="font-semibold uppercase tracking-wider text-black">Navigate</h3>
            <ul className="mt-4 space-y-2">
              {navLinks.slice(0, 4).map((link, index) => (
                  <li key={link.name}>
                      <Link 
                        href={link.href} 
                        className={cn("text-sm text-black/80 transition-colors hover:text-black")}
                      >
                          {link.name}
                      </Link>
                  </li>
          ...
          <div className="md:justify-self-center">
            <h3 className="font-semibold uppercase tracking-wider text-black opacity-0 md:opacity-100">.</h3>
            <ul className="mt-4 space-y-2">
        ...
        <div className="mt-12 border-t border-black/20 pt-8 text-center text-sm text-black/80 flex flex-col md:flex-row justify-between items-center gap-4">
            {currentYear && <p className="font-bold text-black">&copy; {currentYear} RagaMagazine. All rights reserved.</p>}
            <div className="flex space-x-4">
            <Button variant="ghost" size="icon" asChild className="text-black/80 hover:text-black hover:bg-black/10">
